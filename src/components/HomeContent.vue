<template>
	<div style="background-color: white;">
		...
		<div style="text-align: center; margin-top: 10vw;">
			...
			<div style="display: inline-block; margin-left: 30px; font-weight:900; margin-top: 10px;">
			...
			<div style="margin-top: 5vw; font-weight: bold; font-size: 1.3vw;">
				<div style="margin-top: 25px; ">或许你来到新的环境，感到孤单难以适应</div>
				<div style="margin-top: 12px; ">或许你很想变得优秀，实现自己心中目标</div>
				<div style="margin-top: 12px; ">或许你面对压力焦虑，希望有人分担帮助</div>
				<div style="margin-top: 12px; ">或许你正在经历苦恼，需要有人安慰倾听</div>
			</div>
			<div style="margin-top: 30px;">
				...
				<div style="margin-top: 20px;;"><a href="https://shimo.im/sheets/XDhvpJ8QQKh6XvHq/xUGGo" class="home-shimo-link">查看值班表，好buddy不会丢！</a></div>
			</div>
