<template>
	<div>
		...
		<PsyResourceContent id="psyresource-content"/>
...
import PsyResourceContent from "../components/PsyResourceContent.vue";
	...
	document.onreadystatechange = function (){
			if(document.readyState == "complete") {
				if(document.documentElement.clientWidth < 700) {
					document.getElementById("psyresource-content").style.fontSize="2vw";
				}else{
					document.getElementById("psyresource-content").style.fontSize="1.15vw";
				}
				if(document.documentElement.clientWidth < 1000) {
					...
					document.getElementById("psyresource-content").style.paddingTop="16vw";
				}else{
					document.getElementById("normal-header").style.height="140px";
					document.getElementById("normal-header").style.lineHeight="140px";
					document.getElementById("psyresource-content").style.paddingTop="160px";
				}
			}
		}
